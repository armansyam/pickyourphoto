  ...
  `);
    ...
    try {
        ...
        if (planCount === 0) {
            ...
            insertPlan.run('Tier 1', 5, 75000, 99999, 150, 30, 'limit', 51200);
            insertPlan.run('Tier 2', 15, 150000, 99999, 400, 30, 'limit', 51200);
            insertPlan.run('Tier 3', 35, 300000, 99999, 900, 30, 'limit', 51200);

            // Storage-based default plans (Free Trial set to 1 day)
            insertPlan.run('Trial Storage', 99999, 0, 99999, 99999, 1, 'storage', 50);
            insertPlan.run('Base', 99999, 75000, 99999, 99999, 30, 'storage', 2048);
            insertPlan.run('Pro', 99999, 150000, 99999, 99999, 30, 'storage', 5120);
            insertPlan.run('Business', 99999, 300000, 99999, 99999, 30, 'storage', 15360);
