...
if (!isNextBuild) {
    ...
    setInterval(() => {
        try {
            ...
            if (expiredSessions.changes > 0 || archivedVendors.changes > 0 || deletedVendors.changes > 0 || deletedLeads.changes > 0) {
                console.log(`[DB Cleanup] Sessions expired: ${expiredSessions.changes}, Archived: ${archivedVendors.changes}, Deleted: ${deletedVendors.changes}, Leads cleaned: ${deletedLeads.changes}`);
            }
        } catch (cleanupErr) {
