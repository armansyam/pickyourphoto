...
export function getSmtpConfig() {
    try {
        ...
        return {
            ...
            fromName: settings.smtp_from_name || settings.saas_name || 'Pick Your Photo'
        };
    } catch (err) {
            ...
            html: `
                <div style="font-family: 'Segoe UI', Helvetica, Arial, sans-serif; background-color: #09090b; color: #f4f4f5; padding: 40px 20px; max-width: 600px; margin: 0 auto; border-radius: 16px; border: 1px solid rgba(255,255,255,0.1);">
                    <div style="text-align: center; padding-bottom: 24px; border-bottom: 1px solid rgba(255,255,255,0.08); margin-bottom: 28px;">
                        <h1 style="color: #818cf8; font-size: 28px; margin: 0; font-weight: 800; letter-spacing: -0.5px;">${config.fromName}</h1>
                        <p style="color: #a1a1aa; font-size: 13px; margin: 6px 0 0 0; font-weight: 500;">Platform Seleksi Foto Digital Terpercaya</p>
                    </div>
                    ...
                    <div style="background: rgba(18, 18, 24, 0.95); padding: 28px; border-radius: 14px; border: 1px solid rgba(255,255,255,0.08); margin-bottom: 24px;">
                        <h2 style="color: #34d399; font-size: 22px; margin: 0 0 12px 0; font-weight: 700;">Halo, ${vendor.name}! 👋</h2>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="background: rgba(16, 185, 129, 0.06); border: 1px solid rgba(16, 185, 129, 0.25); border-radius: 12px; margin-bottom: 24px;">
                            <tr>
                                <td style="padding: 20px;">
                                    <div style="font-size: 13px; color: #34d399; font-weight: 800; margin-bottom: 14px; text-transform: uppercase; letter-spacing: 0.8px;">
                                        🧾 BUKTI INVOICE PEMBAYARAN LUNAS
                                    </div>
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="font-size: 14px; color: #d4d4d8;">
                                        <tr>
                                            <td style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.06); color: #a1a1aa; width: 45%;">No. Invoice</td>
                                        ...
                                        <tr>
                                            ...
                                            <td align="right" style="padding: 8px 0; border-bottom: 1px solid rgba(255,255,255,0.06); font-weight: bold; color: #38bdf8;">💾 Drive ${addonQuotaGb} GB</td>
                                        </tr>
                                        ` : ''}
                                        <tr>
                                            <td style="padding: 12px 0 4px 0; color: #a1a1aa; font-weight: bold;">Status Pembayaran</td>
                                            <td align="right" style="padding: 12px 0 4px 0; font-weight: 800; color: #34d399; font-size: 15px;">🟢 PAID / LUNAS (VERIFIED)</td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
                        ...
                        <p style="font-size: 14px; color: #a1a1aa; line-height: 1.6; margin: 0 0 24px 0;">
                            Anda sudah dapat masuk ke dashboard studio Anda untuk mulai membuat galeri seleksi foto klien.
                        </p>

                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                <td align="center">
                                    <a href="${loginUrl}" style="background: linear-gradient(135deg, #6366f1, #4f46e5); color: #ffffff; padding: 15px 36px; border-radius: 12px; text-decoration: none; font-weight: bold; font-size: 15px; display: inline-block; box-shadow: 0 6px 20px rgba(99, 102, 241, 0.4);">
                    ...
                    <div style="text-align: center; font-size: 12px; color: #71717a; border-top: 1px solid rgba(255,255,255,0.08); padding-top: 20px; line-height: 1.5;">
