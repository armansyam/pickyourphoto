...
export async function generateMetadata() {
    ...
    return {
        title: `Tentang Kami — ${saasName}`,
        description: `Profil platform ${saasName}, solusi seleksi foto digital dan alur kerja cerdas untuk fotografer dan studio profesional.`
    };
}
