            ...
            <div style={{
                ...
                <section style={{ marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                        ...
                        <h2 style={{ fontSize: '19px', fontWeight: '700', color: '#1C1917', margin: 0, fontFamily: '"Fraunces", Georgia, serif' }}>1. Ketentuan Umum</h2>
                    </div>
                ...
                <section style={{ marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                        ...
                        <h2 style={{ fontSize: '19px', fontWeight: '700', color: '#1C1917', margin: 0, fontFamily: '"Fraunces", Georgia, serif' }}>2. Akun Vendor &amp; Tanggung Jawab Pengguna</h2>
                    </div>
                ...
                <section style={{ marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                        ...
                        <h2 style={{ fontSize: '19px', fontWeight: '700', color: '#1C1917', margin: 0, fontFamily: '"Fraunces", Georgia, serif' }}>3. Ketentuan Pembayaran &amp; Langganan</h2>
                    </div>
                    <ul style={{ paddingLeft: '20px', color: '#44403C', fontSize: '15px' }}>
                ...
                <section style={{ marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                        ...
                        <h2 style={{ fontSize: '19px', fontWeight: '700', color: '#1C1917', margin: 0, fontFamily: '"Fraunces", Georgia, serif' }}>4. Hak Cipta &amp; Kepemilikan Materi</h2>
                    </div>
                    <p style={{ color: '#44403C', fontSize: '15px' }}>
