            ...
            <div style={{
                ...
                <section style={{ marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                        ...
                        <h2 style={{ fontSize: '19px', fontWeight: '700', color: '#FFFFFF', margin: 0 }}>
                ...
                <section style={{ marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                        <div style={{ padding: '6px', borderRadius: '8px', background: 'rgba(52,211,153,0.15)', color: '#34D399' }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div style={{ background: 'rgba(52,211,153,0.05)', border: '1px solid rgba(52,211,153,0.2)', borderRadius: '12px', padding: '18px 20px', marginBottom: '14px' }}>
                        <p style={{ color: '#EAE8F7', fontSize: '14.5px', margin: 0 }}>
                ...
                <section style={{ marginBottom: '32px' }}>
                    ...
                    <ul style={{ paddingLeft: '20px', color: '#D8D5EE', fontSize: '15px' }}>
                        ...
                        <li style={{ marginBottom: '10px' }}>
                            <strong>Grace Period:</strong> Setelah masa aktif berakhir, sistem memberikan masa tenggang (*grace period*) selama 7 hari agar pengguna memiliki waktu mengunduh atau merapikan data sebelum akun dibekukan sementara.
                        </li>
                    </ul>
                </section>
                ...
                <section style={{ marginBottom: '32px' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '14px' }}>
                        <div style={{ padding: '6px', borderRadius: '8px', background: 'rgba(251,191,36,0.15)', color: '#FBBF24' }}>
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <p style={{ color: '#D8D5EE', fontSize: '15px', marginBottom: '12px' }}>
                        Permohonan pengembalian dana (*refund*) dapat diproses dan disetujui dalam kondisi-kondisi berikut:
                    </p>
                    <ul style={{ paddingLeft: '20px', color: '#D8D5EE', fontSize: '15px' }}>
                        <li style={{ marginBottom: '10px' }}>
                ...
                <section style={{ background: 'rgba(99,102,241,0.06)', border: '1px solid rgba(99,102,241,0.2)', borderRadius: '12px', padding: '24px', marginBottom: '32px' }}>
                    <h3 style={{ fontSize: '16px', fontWeight: '700', color: '#818CF8', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    <p style={{ color: '#D8D5EE', fontSize: '14.5px', margin: '0 0 12px 0' }}>
                        Untuk mengajukan klaim pengembalian dana, silakan kirimkan email resmi ke:
                    </p>
                    <div style={{ display: 'inline-block', background: 'rgba(0,0,0,0.3)', padding: '6px 14px', borderRadius: '6px', border: '1px solid rgba(129,140,248,0.2)', marginBottom: '14px' }}>
                        <a href={`mailto:${settings.email}?subject=Permohonan%20Refund%20-%20Pick%20Your%20Photo`} style={{ color: '#34D399', textDecoration: 'none', fontWeight: '600', fontSize: '14.5px' }}>
                            {settings.email}
                        </a>
                    </div>
                    ...
                    <ol style={{ paddingLeft: '20px', color: '#D8D5EE', fontSize: '14px', margin: '0 0 12px 0' }}>
                    ...
                    <p style={{ color: '#9791B8', fontSize: '13px', margin: 0 }}>
